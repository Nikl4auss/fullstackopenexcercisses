...
describe("total likes", () => {
  ...
  test("of one blog equals to that", () => {
    expect(listHelper.totalLikes(listWithOneBlog)).toBe(8);
  });
  test("of many its calculated just right", () => {
    expect(listHelper.totalLikes(listWithManyBlogs)).toBe(24);
  });
});
...
describe("most blogs", () => {
  ...
  test.only("the author with most blogs is", () => {
